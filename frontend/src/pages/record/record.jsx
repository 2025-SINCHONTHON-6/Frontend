        ...
        <div className='flex flex-col items-center gap-[20px]'>
            ...
            <div className="flex-col items-center justify-center w-[100%] h-auto p-[30px] mb-[15px] rounded-[30px] bg-main-100 ">
                <div className='flex flex-col items-center w-[100%]'>
                  <h2 className='text-[24px] font-[700] text-main-300'>추천받은 차를 다 기록했어요!</h2>
                  <img src={noRecordIcon} alt="" className='m-1'/>
                </div>
                <div className='flex justify-center '>
                    <button className='text-main-300 w-[100%] p-5 text-[24px] font-[700] rounded-[20px] bg-white' onClick={()=>navigate('/recommend/moodpick')}>새로운 차 추천받기</button>
                </div>
            </div>
      ...
      <main className="relative w-full max-w-[390px] pl-[20px] pr-[20px] items-center bg-white">
        <div className='flex flex-col items-center gap-[20px]'>
            ...
            <div className='flex flex-col items-start w-[100%]'>
              ...
              <h4 className='text-gray-400 text-[16px] font-[700] mb-1'>매일매일 차를 마시고 기록해봐요</h4>
            </div>
